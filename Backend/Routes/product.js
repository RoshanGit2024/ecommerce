...
const {getAdminProducts, getProducts, getSingleProducts ,getReviews,postProducts,updateProduct,deleteProduct,createReview, deleteReview} = require('../controllers/productcontroller');
